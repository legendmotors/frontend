...
const imageData = [
  {
    imgSrc: "/assets/images/section/listing-detai-1.jpg",
    alt: "image",
  },
  {
    imgSrc: "/assets/images/section/listing-detai-2.jpg",
    alt: "image",
  },
  {
    imgSrc: "/assets/images/section/listing-detai-3.jpg",
    alt: "image",
  },
  {
    imgSrc: "/assets/images/section/listing-detai-1.jpg",
...
export default function Slider2() {
  ...
  return (
    <Swiper
      ...
      className="swiper carousel-9 slider home mb-40"
      id="my-gallery"
    >
      {imageData.map((elm, i) => (
      ...
      <div className="swiper-pagination3 spd2" />
    </Swiper>
  );
}
