...
export default function Cars() {
  return (
    <>
      {" "}
      {carListings2.slice(3, 6).map((elm, i) => (
        <div key={i} className="box-car-list style-2 hv-one mb-3">
          ...
          <div className="content">
            ...
            <h5 className="link-style-1">
              <Link href={`/listing-detail-v2/${elm.id}`}>{elm.title}</Link>
            </h5>
            ...
            <div className="days-box flex justify-space align-center">
              <div className="img-author">
                <Image
                  ...
                  height={120}
                />
                <span className="font text-color-2 fw-5">{elm.authorName}</span>
              </div>
              <Link href={`/listing-detail-v2/${elm.id}`} className="view-car">
                View car
              </Link>
            </div>
          </div>
